  ...
  private
    ...
    def address_params
      params.require(:location).permit(:street, :city, :geographicalRegion, :country, :postal_code,
                                      ...
                                      :sunday_hours_is_open, :monday_hours_is_open, :tuesday_hours_is_open, :wednesday_hours_is_open, :thursday_hours_is_open, :friday_hours_is_open, :saturday_hours_is_open,)
    end
